...
public class MysticTomato : MonoBehaviour
{
    ...
    {
        DeckManager.instance.SummonMonsterFromDeck(monster => monster.GetMonsterInfo().attack <= 1500 && monster.GetMonsterInfo().attribute == CardDataTypes.MonsterAttribute.Dark);
    }
}
