...
public class MaskedDragon : MonoBehaviour
{
    ...
    {
        DeckManager.instance.SummonMonsterFromDeck(monster => monster.GetMonsterInfo().attack <= 1500 && monster.GetMonsterInfo().type == CardDataTypes.MonsterType.Dragon);
    }
}
